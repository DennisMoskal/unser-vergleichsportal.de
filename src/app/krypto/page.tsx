"use client"
import { Button } from "@/components/ui/button"import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"import { Badge } from "@/components/ui/badge"import { Tabs, TabsList, TabsTrigger } from "@/components/ui/tabs"import { Shield, PiggyBank, Heart, TrendingUp } from "lucide-react"import Link from "next/link"import Head from "next/head"
const providerData = {  trading: [    {      name: "Kraken",      rating: 4.6,      features: ["Hohe Sicherheit", "Niedrige Gebühren", "Viele Kryptowährungen", "Staking Rewards"],      price: "0,16% Maker Fee",      bonus: "Bis zu 10% Staking-APY",      logo: "🐙",      url: "/anbieter/kraken"    },    {      name: "Bybit",      rating: 4.4,      features: ["Derivatives Trading", "Bis zu 100x Leverage", "Advanced Trading Tools", "Krypto-Spot-Handel"],      price: "0,1% Taker Fee",      bonus: "Bis zu $30.000 Trading Bonus",      logo: "⚡",      url: "/anbieter/bybit"    },    {      name: "eToro",      rating: 4.3,      features: ["Social Trading", "Copy Trading", "Benutzerfreundliche Plattform", "Aktien & Krypto"],      price: "1% Spread",      bonus: "Kostenloses Demo-Portfolio",      logo: "🌐",      url: "/anbieter/etoro"    },    {      name: "XTB",      rating: 4.5,      features: [        "Gratis Aktie für neue Investoren",        "Bis zu 2,3% Zinsen auf Guthaben",        "Über 8000 Aktien & ETFs",        "Über 2600 CFD-Instrumente",        "Über 40 Krypto-CFDs",        "eWallet mit virtueller Mastercard",        "Smarte ETF-Sparpläne",        "0% Kommission bis 100.000€",        "Kostenlose Ein- & Auszahlungen",        "Platz 1 CFD-Broker 2024/25"      ],      price: "0€ Kommission",      bonus: "Kostenlose Kontoeröffnung",      logo: "📊",      url: "https://link-pso.xtb.com/pso/lMDhc"    },  ],}
export default function Trading() {  return (                  Trading: Krypto & Aktienhandel - SmartFinanz                        <br>          {JSON.stringify({<br>            "@context": "<a href="https://schema.org">https://schema.org</a>",<br>            "@type": "FAQPage",<br>            "mainEntity": [<br>              {<br>                "@type": "Question",<br>                "name": "Was ist der Unterschied zwischen Krypto- und Aktienhandel?",<br>                "acceptedAnswer": {<br>                  "@type": "Answer",<br>                  "text": "Krypto-Handel bezieht sich auf den Kauf und Verkauf von Kryptowährungen wie Bitcoin oder Ethereum, oft über Spot- oder Derivate-Handel. Aktienhandel umfasst den Handel mit Unternehmensanteilen an der Börse, einschließlich ETFs und CFDs. Beide bieten Chancen, unterscheiden sich aber in Volatilität und Regulierung."<br>                }<br>              },<br>              {<br>                "@type": "Question",<br>                "name": "Welche Plattform ist die beste für Einsteiger?",<br>                "acceptedAnswer": {<br>                  "@type": "Answer",<br>                  "text": "Für Einsteiger sind Plattformen wie eToro ideal, da sie benutzerfreundlich sind und Features wie Social Trading und Demo-Konten bieten. XTB ist ebenfalls geeignet, dank kostenloser Kontoeröffnung und umfangreicher Bildungsressourcen."<br>                }<br>              }<br>            ]<br>          })}<br>              
  ...
  {/* Anbieter-Vergleich */}
  <section id="anbieter" className="py-8 sm:py-12 bg-white">
    <div className="container mx-auto px-4">
