...
const providerData = [
  ...
  rating: 4.7,
  features: [
    "<h4>Umfassender Schutz für Hunde und Katzen</h4>",
    "<h4>Bis zu 100% Kostenerstattung für Operationen</h4>",
    "Testsieger bei Stiftung Warentest (08/2025)",
    "<h4>Keine Wartezeit bei Unfällen</h4>",
...
},
{
  ...
  rating: 4.6,
  features: [
    "<h4>Tierversicherung für Hunde, Katzen und Pferde</h4>",
    "<h4>Bis zu 5.000€ jährliche Deckung</h4>",
    "Schnelle Schadenbearbeitung innerhalb 48h",
    "<h4>Zusatzschutz für Zahnbehandlungen</h4>",
  ...
  metaTitle: "Figo Tierversicherung: Flexible Tarife für Haustiere 2025",
  metaDescription: "Figo bietet flexible Tierversicherungen für Hunde, Katzen und Pferde mit schneller Schadenbearbeitung. Jetzt vergleichen!",
  isTopRecommendation: true,
},
{
  name: "HanseMerkur",
  rating: 4.5,
  features: [
    "<h4>Tierversicherung ohne Altersbegrenzung</h4>",
    "<h4>Bis zu 100% Kostenerstattung für Behandlungen</h4>",
    "Testsieger bei Focus Money (07/2025)",
    "<h4>Schutz für Vorsorgeuntersuchungen</h4>",
...
},
{
  ...
  rating: 4.8,
  features: [
    "<h4>Vergleich von über 50 Tierversicherungen</h4>",
...
},
{
  ...
  rating: 4.6,
  features: [
    "<h4>Schutz für Hunde, Katzen und Pferde</h4>",
    "<h4>Bis zu 6.000€ jährliche Deckung</h4>",
    "eKomi-Bewertung: 4,6/5 Sterne",
    "<h4>Schneller Schadenservice (24/7)</h4>",
...
},
{
  ...
  rating: 4.6,
  features: [
    "<h4>Flexible Tierversicherungen für Katzen und Hunde</h4>",
    "<h4>100% digitale Buchung und Schadenmeldung</h4>",
    "Monats- oder Jahresabo ohne Selbstbeteiligung",
    "<h4>Schutz für Vorsorge und Operationen</h4>",
  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "WebPage",
        "name": "Beste Tierversicherungen November 2025 | Hunde, Katzen & Welpen",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-6">
              Beste Tierversicherungen November 2025 | Hunde- und Katzenversicherungen im Vergleich
            </h1>
