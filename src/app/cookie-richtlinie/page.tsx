      ...
      <section className="py-12 sm:py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-8 text-center">
            Diese Cookie-Richtlinie erläutert, SmartFinanz unser-vergleichsportl.de Cookies und ähnliche Technologien auf unserer Website verwendet, um Ihnen ein optimales Nutzererlebnis zu bieten und unsere Dienste zu verbessern.
          </p>
