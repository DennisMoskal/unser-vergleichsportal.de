    ...
    <Link href="/" aria-label="Zurück zur Startseite">
      <div className={`flex flex-col items-start ${className}`}>
        <div className="flex items-center space-x-1">
          ...
          <span className="font-bold text-base sm:text-lg">martFinanz</span>
        </div>
  ...
  return (
    <>
      <header className="bg-white shadow-sm relative border-b">
        ...
        {/* Mobiles Menü */}
        {mobileMenuOpen && (
          <div className="sm:hidden absolute top-full left-0 right-0 bg-white shadow-lg border-t z-50 max-h-[80vh] overflow-y-auto">
            <nav className="px-4 py-4 space-y-5" aria-label="Mobiles Menü">
              <div>
                <h2 className="font-semibold text-lg mb-2 text-left ml-2">Finanzprodukte</h2>
                <ul className="flex flex-col gap-1.5 text-sm">
                  {[
                    ...
                    <li key={key}>
                      <Link
                        href={url}
                        className="inline-block px-3 py-2 font-medium transition-all duration-300 ease-in-out text-sm rounded-lg hover:bg-green-600 hover:text-white hover:scale-105 hover:shadow-lg hover:bg-gradient-to-b hover:from-green-600 hover:to-green-700"
                        onClick={() => {
              ...
              <div>
                <h2 className="font-semibold text-lg mb-2 text-left ml-2">Weitere Produkte</h2>
              ...
              <div>
                <h2 className="font-semibold text-lg mb-2 text-left ml-2">Unternehmen</h2>
                <ul className="flex flex-col gap-1.5 text-sm">
                  {[
              ...
              <div>
                <h2 className="font-semibold text-lg mb-2 text-left ml-2">Rechtliches</h2>
                <ul className="flex flex-col gap-1.5 text-sm">
                  {[
              ...
              <div className="text-center mt-4">
                <Button
                  className="w-auto bg-green-600 text-white font-medium text-sm px-4 py-2 transition-all duration-300 ease-in-out rounded-lg hover:bg-green-700 hover:scale-105 hover:shadow-lg hover:bg-gradient-to-b hover:from-green-600 hover:to-green-700"
      ...
      <section className="bg-white py-3 border-b overflow-x-auto" id="versicherungen">
        <div className="container mx-auto px-3 sm:px-4">
          <ul className="flex gap-2 text-sm whitespace-nowrap min-w-max sm:flex-wrap sm:justify-center">
            {[
              { key: 'banking', label: 'Banking', url: '/banking', isInternal: true },
              { key: 'haustierversicherung', label: 'Haustiervers.', labelFull: 'Haustierversicherung', url: '/tierversicherungen', isInternal: true },
              { key: 'trading', label: 'Trading', url: '/trading', isInternal: true },
              ...
              { key: 'gas', label: 'Gas', url: 'https://www.c24n.de/Uxudvkj', isInternal: false },
              { key: 'handytarif', label: 'Handy', labelFull: 'Handytarif', url: 'https://www.c24n.de/5R17qbN', isInternal: false },
              { key: 'kreditkarte', label: 'Kreditkarte', url: 'https://www.c24n.de/RYXPGyh', isInternal: false },
              { key: 'mietwagen', label: 'Mietwagen', url: 'https://www.c24n.de/FZ9nd0R', isInternal: false },
              { key: 'oekostrom', label: 'Ökostrom', url: 'https://www.c24n.de/zxy0WKh', isInternal: false },
              { key: 'reise', label: 'Reise', url: 'https://www.c24n.de/EieKR0E', isInternal: false },
              { key: 'strom', label: 'Strom', url: 'https://www.c24n.de/RYXPGyh', isInternal: false },
            ].map(({ key, label, labelFull, url, isInternal }) => (
              <li key={key}>
                {isInternal ? (
                  <Link
                    href={url}
                    className="block px-2.5 sm:px-3 py-1.5 sm:py-2 font-medium transition-all duration-300 ease-in-out text-sm rounded-lg hover:bg-green-600 hover:text-white hover:scale-105 hover:shadow-lg hover:bg-gradient-to-b hover:from-green-600 hover:to-green-700"
                    onClick={() => setActiveCategory(key)}
                    aria-label={`Zu ${labelFull || label} navigieren`}
                  >
                    {label}
                  </Link>
                ) : (
                  <a
                    ...
                    className="block px-2.5 sm:px-3 py-1.5 sm:py-2 font-medium transition-all duration-300 ease-in-out text-sm rounded-lg hover:bg-green-600 hover:text-white hover:scale-105 hover:shadow-lg hover:bg-gradient-to-b hover:from-green-600 hover:to-green-700"
                    onClick={() => setActiveCategory(key)}
                    aria-label={`${labelFull || label} vergleichen (externer Link)`}
                  >
                    {label}
                  </a>
                )}
    ...
    <>
      ...
      <main>
        <div className="min-h-screen bg-white">
          ...
          {/* Hauptinhalt */}
          <section className="py-8 sm:py-12 lg:py-16 px-3 sm:px-4 bg-gray-50">
            <div className="container mx-auto max-w-4xl">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 text-gray-900 text-center">
                Impressum
              </h1>
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 mb-6 sm:mb-8 text-center px-2">
              ...
              <Card className="bg-white border-2 hover:border-green-200 transition-shadow hover:shadow-lg mx-auto max-w-2xl mb-6 sm:mb-8">
                <CardHeader>
          ...
          {/* Call to Action */}
          <section className="py-8 sm:py-12 lg:py-16 bg-green-600 text-white px-3 sm:px-4">
          ...
          <footer className="bg-gray-900 text-white py-6 sm:py-8 lg:py-12 px-3 sm:px-4">
            <div className="container mx-auto">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8">
                ...
                <div>
                  <span className="font-semibold mb-3 text-lg sm:text-xl block">Finanzprodukte</span>
                  <ul className="space-y-2 text-sm sm:text-base text-gray-400">
                    <li>
                      <Link
                        href="/banking"
                        className="hover:text-white transition-all duration-300 ease-in-out hover:scale-105 rounded-lg hover:bg-gradient-to-b hover:from-gray-800 hover:to-gray-900 hover:shadow-sm inline-block"
                        aria-label="Banking"
                      >
                        Banking
                      </Link>
                ...
                <div>
                  <span className="font-semibold mb-3 text-lg sm:text-xl block">Weitere Produkte</span>
                ...
                <div>
                  <span className="font-semibold mb-3 text-lg sm:text-xl block">Unternehmen</span>
                  <ul className="space-y-2 text-sm sm:text-base text-gray-400">
                    <li>
                      <Link
                        href="/karriere"
                ...
                <div>
                  <span className="font-semibold mb-3 text-lg sm:text-xl block">Rechtliches</span>
                  <ul className="space-y-2 text-sm sm:text-base text-gray-400">
                    <li>
                      <Link
                        href="/agb"
