    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 sm:py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-gray-900 text-center">Impressum</h2>
      ...
      <section className="py-12 sm:py-16 bg-green-600 text-white">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg sm:text-xl mb-8 text-green-100">
            Für weitere Details oder Fragen zu unseren rechtlichen Angaben kontaktieren Sie uns gerne oder besuchen Sie unsere anderen Seiten.
          </p>
          <Link href="/kontakt">
