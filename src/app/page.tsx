...
const Header: React.FC = () => {
  ...
  return (
    <>
          ...
          <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden flex flex-col h-full">
              <CardHeader className="pb-4 flex-shrink-0">
                <div className="flex items-center space-x-4">
                  <Image
                    src="/images/kundenbewertungen/sophie.jpg"
                    alt="Kundenbewertung von Sophie, 35"
                    width={80}
                    height={80}
                    loading="lazy"
                    className="h-16 w-16 sm:h-20 sm:w-20 rounded-full object-cover flex-shrink-0 border-0"
                  />
                  <div className="flex-grow min-w-0">
                    <CardTitle className="text-lg sm:text-xl font-semibold text-gray-900 truncate">Sophie, 35</CardTitle>
                    <div className="flex items-center mt-1">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className="h-4 w-4 sm:h-5 sm:w-5 text-yellow-400 fill-current" aria-hidden="true" />
                      ))}
              ...
              <CardContent className="p-4 sm:p-6 pt-0 flex flex-col flex-grow">
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed flex-grow">
                  "Ich habe über SmartFinanz einen günstigen Kredit gefunden. Die Antragstellung war kinderleicht und die Auszahlung super schnell!"
                </p>
                <Button
                  variant="default"
                  className="w-full bg-green-600 text-white font-medium text-sm sm:text-base rounded-lg mt-4 flex-shrink-0 transition-all duration-300 ease-in-out hover:bg-green-700 hover:scale-105 hover:shadow-lg hover:bg-gradient-to-b hover:from-green-600 hover:to-green-700"
            ...
            <Card className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden flex flex-col h-full">
              <CardHeader className="pb-4 flex-shrink-0">
                <div className="flex items-center space-x-4">
                  <Image
                    src="/images/kundenbewertungen/thomas.jpg"
                    alt="Kundenbewertung von Thomas, 50"
                    width={80}
                    height={80}
                    loading="lazy"
                    className="h-16 w-16 sm:h-20 sm:w-20 rounded-full object-cover flex-shrink-0 border-0"
                  />
                  <div className="flex-grow min-w-0">
                    <CardTitle className="text-lg sm:text-xl font-semibold text-gray-900 truncate">Thomas, 50</CardTitle>
                    <div className="flex items-center mt-1">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className={`h-4 w-4 sm:h-5 sm:w-5 ${i < 4 ? 'text-yellow-400 fill-current' : 'text-gray-300'}`} aria-hidden="true" />
                      ))}
              ...
              <CardContent className="p-4 sm:p-6 pt-0 flex flex-col flex-grow">
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed flex-grow">
                  "Die Plattform ist übersichtlich und die Angebote sind top! Ich habe schnell das beste DSL-Angebot gefunden und spare jetzt monatlich."
                </p>
                <Button
                  variant="default"
                  className="w-full bg-green-600 text-white font-medium text-sm sm:text-base rounded-lg mt-4 flex-shrink-0 transition-all duration-300 ease-in-out hover:bg-green-700 hover:scale-105 hover:shadow-lg hover:bg-gradient-to-b hover:from-green-600 hover:to-green-700"
      ...
      <section className="py-12 sm:py-16 bg-white" id="statistics-section">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">SmartFinanz in Zahlen</h2>
          <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-4">
            <Card className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 text-center">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl font-bold">500+</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm sm:text-base">Finanzprodukte im Vergleich</p>
              </CardContent>
            </Card>
            <Card className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 text-center">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl font-bold">1.000€</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm sm:text-base">Mögliche jährliche Ersparnis</p>
              </CardContent>
            </Card>
            <Card className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 text-center">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl font-bold">4,8/5</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm sm:text-base">Durchschnittliche Kundenbewertung</p>
              </CardContent>
            </Card>
            <Card className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 text-center">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl font-bold">100.000+</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm sm:text-base">Zufriedene Nutzer</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 bg-gray-50" id="faq-section">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">Häufig gestellte Fragen</h2>
          <div className="max-w-3xl mx-auto space-y-6 sm:space-y-8">
            <Card className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl font-semibold">Wie funktioniert der Vergleich auf SmartFinanz?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm sm:text-base">
                  Auf SmartFinanz können Sie über 500 Finanzprodukte wie Versicherungen, Girokonten, Kredite, DSL, Strom und Gas vergleichen. Geben Sie Ihre Anforderungen in unsere Suchmaske ein, und wir zeigen Ihnen die besten Angebote von vertrauenswürdigen Anbietern wie Tarifcheck.de, CHECK24 oder Credimaxx. Der Vergleich ist kostenlos und unverbindlich.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl font-semibold">Ist der Vergleich wirklich kostenlos?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm sm:text-base">
                  Ja, unser Vergleich ist 100% kostenlos und unverbindlich. Wir finanzieren uns durch Provisionen von Anbietern, wenn Sie ein Produkt über unsere Links abschließen. Dies hat keinen Einfluss auf den Preis für Sie.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl font-semibold">Wie aktuell sind die Angebote?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm sm:text-base">
                  Unsere Angebote werden täglich aktualisiert, um Ihnen die aktuellsten Konditionen und Boni zu präsentieren. So stellen wir sicher, dass Sie immer die besten verfügbaren Tarife finden.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl font-semibold">Welche Anbieter sind bei SmartFinanz vertreten?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm sm:text-base">
                  Wir arbeiten mit renommierten Anbietern wie Tarifcheck.de, CHECK24, Credimaxx, HanseMerkur, Vodafone, 1&1, Verivox und vielen mehr zusammen. Alle Anbieter sind geprüft und bieten hochwertige Finanzprodukte.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 sm:gap-8 md:grid-cols-5">
            <div className="col-span-2 md:col-span-1">
              <div className="flex flex-col items-start mb-4">
                <SmartFinanzLogo className="text-2xl text-white" />
              </div>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-base text-gray-400">
                {[
                  { label: 'Banking', url: '/banking' },
                  { label: 'Haustierversicherung', url: '/tierversicherungen' },
                  { label: 'Trading', url: '/trading' },
                  { label: 'Versicherungen', url: '/versicherungen' },
                ].map(({ label, url }) => (
                  <li key={label}>
                    <Link 
                      href={url} 
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <ul className="space-y-2 text-base text-gray-400">
                  {[
                    { label: 'DSL', url: 'https://www.c24n.de/ducwCtq' },
                    { label: 'Gas', url: 'https://www.c24n.de/Uxudvkj' },
                    { label: 'Handytarif', url: 'https://www.c24n.de/5R17qbN' },
                    { label: 'Kreditkarte', url: 'https://www.c24n.de/RYXPGyh' },
                  ].map(({ label, url }) => (
                    <li key={label}>
                      <a 
                        href={url} 
                ...
                <ul className="space-y-2 text-base text-gray-400">
                  {[
                    { label: 'Mietwagen', url: 'https://www.c24n.de/FZ9nd0R' },
                    { label: 'Ökostrom', url: 'https://www.c24n.de/zxy0WKh' },
                    { label: 'Reise', url: 'https://www.c24n.de/EieKR0E' },
                    { label: 'Strom', url: 'https://www.c24n.de/RYXPGyh' },
                  ].map(({ label, url }) => (
                    <li key={label}>
                      <a 
                        href={url} 
            ...
            <div>
              ...
              <ul className="space-y-2 text-base text-gray-400">
                {[
                  ...
                  { label: 'Partnerprogramm', url: '/partnerprogramme' },
            ...
            <div>
              ...
              <ul className="space-y-2 text-base text-gray-400">
                {[
                  { label: 'AGB', url: '/agb' },
                  { label: 'Cookie-Richtlinie', url: '/cookie-richtlinie' },
