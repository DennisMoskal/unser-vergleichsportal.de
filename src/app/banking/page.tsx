...
const providerData = [
  ...
  rating: 4.5,
  features: [
    "<h4>Kostenloser Vergleichstarifrechner</h4>",
    "<h4>Girokonto Neukundenbonus bis 120€</h4>",
    "Über 20 Jahre Erfahrung als Vergleichsportal",
    "100% kostenloser und unverbindlicher Vergleich",
    "<h4>Mehrfach ausgezeichnet mit 'sehr gut' (Handelsblatt 09/2024)</h4>",
...
},
{
  ...
  rating: 4.7,
  features: [
    "<h4>Kostenloses Girokonto mit 100€ Prämie</h4>",
    "<h4>Visa Kreditkarte ohne Jahresgebühr</h4>",
    "Visa Kreditkarte ohne Jahresgebühr, weltweit kostenlos bezahlen",
    "<h4>Tagesgeldkonto mit 3,5% Zinsen p.a.</h4>",
...
},
{
  ...
  rating: 4.9,
  features: [
    "<h4>Kreditvermittlung ohne Schufa</h4>",
    "<h4>Digitale Kreditbeantragung mit WebID</h4>",
    ...
    "<h4>TÜV Kundenzufriedenheit: 1.9 (sehr gut)</h4>",
...
},
{
  ...
  rating: 4.8,
  features: [
    "<h4>Kreditvermittlung für Selbstständige</h4>",
    "<h4>Schufa-neutrale Kreditanfrage</h4>",
    "Kreditvermittlung auch für Selbstständige und Freiberufler",
    "Kooperation mit SWK Bank für schnelle Abwicklung",
    "<h4>eKomi Gold Siegel mit 4,8/5 Sternen</h4>",
...
},
{
  ...
  rating: 4.7,
  features: [
    "<h4>Marktführer im Finanzvergleich</h4>",
    "<h4>Vergleich von 300+ Girokonten</h4>",
    "Marktführer mit über 90% Marktabdeckung bei Girokonten und Krediten",
    "<h4>25 Testsiege im Finanzvergleich</h4>",
...
},
{
  ...
  rating: 4.6,
  features: [
    "<h4>Kreditvergleich mit 40% Zinsersparnis</h4>",
    "<h4>Schufa-neutrale Kreditanfragen</h4>",
    "Kreditvergleich mit über 40% Zinsersparnis im Schnitt",
    "Nirgendwo-Günstiger-Garantie mit bis zu 300€ Rückerstattung",
    "Kostenlose und Schufa-neutrale Kreditanfragen",
    "<h4>TÜV-geprüfte Kreditplattform</h4>",
...
},
{
  ...
  rating: 4.8,
  features: [
    "<h4>Kreditvergleich mit 20+ Banken</h4>",
    "<h4>Schufa-neutrale Kreditanfragen</h4>",
    ...
    "<h4>TÜV-zertifizierte Kreditplattform</h4>",
...
},
{
  ...
  features: [
    "<h4>Kreditvergleich mit 20+ Banken</h4>",
    "<h4>Zinsen ab 0,69% effektivem Jahreszins</h4>",
    "Kreditvergleich mit über 20 Banken für beste Konditionen",
